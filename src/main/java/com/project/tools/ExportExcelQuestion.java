 ...
 */
public class ExportExcelQuestion {
    //显示的导出表的标题
//    private String title;
    ...
    //构造方法，传入要导出的数据
    public ExportExcelQuestion(String title, String[] rowName, List<Object[]>  dataList){
        this.dataList = dataList;
        this.rowName = (String[]) rowName.clone();
//        this.title = title;
    }
...
//                    response = getResponse();
                    ...
                    workbook.write(out);
                    System.out.print("导出路径"+fileName);
